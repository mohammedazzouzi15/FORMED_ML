...
@registry.register_trainer("OptunaTrained")
class OptunaTrained(BaseTrainer):
    """
    ...
    def train(self,trial, disable_eval_tqdm: bool = False) -> None:
        ...
        for epoch_int in range(start_epoch, self.config["optim"]["max_epochs"]):
            ...
            for i in range(skip_steps, len(self.train_loader)):
                ...
                trial.report(self.metrics[primary_metric]["metric"], self.step)
                ...
                if self.step % eval_every == 0:
                    if self.val_loader is not None:
                        ...
                        trial.report(val_metrics[primary_metric]["metric"], self.step)
